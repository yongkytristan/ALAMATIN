...
Sixteen files. Anything not listed must not be able to change an answer â€” that
...
The manifest's `built_from_commit` is the parent of the commit that stores it â€” a
