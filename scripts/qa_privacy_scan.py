...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("tests/test_qa_privacy_scan.py", "indonesian_mobile"): "synthetic numbers proving the scanner works",
    ("tests/test_qa_privacy_scan.py", "assigned_credential"): "synthetic secrets proving the scanner works",
    ("tests/test_qa_privacy_scan.py", "private_key_block"): "a synthetic key header proving the scanner works",
